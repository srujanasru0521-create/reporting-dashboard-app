...
# This line must come after importing 'os' and 'sys' to fix ModuleNotFoundError on Render
sys.path.append(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
...
from modules.products_service import create_product, get_all_products, initialize_products
...
# Create the database tables and initialize products on application startup
create_tables()
initialize_products()
